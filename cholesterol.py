...
moyenne_taux_choleseterol = round(sum([float(val_chol)]for val_chol in total_valeur_cholesterol.split(';')) / len(total_valeur_cholesterol.split(';')))
print(f"La moyenne des taux dfe cholestérol est de {moyenne_taux_choleseterol:.1f}")
